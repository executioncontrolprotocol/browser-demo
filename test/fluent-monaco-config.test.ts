...
describe("FLUENT_BROWSER_MODULE_LIB", () => {
  it("declares @executioncontextprotocol/browser for Monaco editor", () => {
    expect(FLUENT_BROWSER_MODULE_LIB).toContain('declare module "@executioncontextprotocol/browser"')
